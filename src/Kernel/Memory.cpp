...
void init_dynamic_mem() {
    ...
    dynamic_mem_start->next = (dynamic_mem_node*)NULL_POINTER;
    dynamic_mem_start->prev = (dynamic_mem_node*)NULL_POINTER;
}

void print_dynamic_node_size() {
    char node_size_string[256];
    IntToChar(DYNAMIC_MEM_NODE_SIZE, node_size_string);
...
void print_dynamic_mem_node(dynamic_mem_node_t *node) {
    ...
    IntToChar(node->size, size_string);
    print("{size = ");
    print(size_string);
    char used_string[256];
    IntToChar(node->used, used_string);
    print("; used = ");
    print(used_string);
    print("}; ");
}
